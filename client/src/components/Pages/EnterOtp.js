...
const EnterOtp = () => {
    return (
        <div className='bg-primary-mainBg'>
            ...
            <div className='my-8'>
                <h1 className='text-3xl font-bold text-[#333333] px-4 py-2'>Enter OTP</h1>
                <p className=' px-4 pb-2 text-[#666666] text-sm
                '>Enter OTP recieved on your Email ID  </p>
            </div>
            <div className='px-4 space-y-3'>
      
                <div className='space-y-1'>
                    <label className='text-[#333333] font-medium'>OTP </label>
